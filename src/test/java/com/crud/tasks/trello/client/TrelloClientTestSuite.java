...
public class TrelloClientTestSuite {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUserName()).thenReturn("magorzatagalera");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/magorzatagalera/boards?key=test&token=test&fields=name,id&lists=all");
